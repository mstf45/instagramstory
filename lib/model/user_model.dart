...
final users = [
  ...
  UserModel(
    [
      StoryModel(
        "https://images.unsplash.com/photo-1638236816750-f5442bdeb4ec?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=687&q=80",
      ),
    ],
    "İlker Gökbayrak",
  ...
  UserModel(
    [
      StoryModel(
        "https://img.freepik.com/free-photo/modern-special-forces-soldier-camouflage-uniform-looking-sideways-studio-photo-against-dark-textured-wall_613910-20426.jpg?w=996&t=st=1687011324~exp=1687011924~hmac=68f99bb88e10415dc216bc1d954a94b8bde4d055b282e889219b8f1e1b680f05",
      ),
      StoryModel(
